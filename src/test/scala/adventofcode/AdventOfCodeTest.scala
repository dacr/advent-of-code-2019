...
class AdventOfCodeTest extends WordSpec with Matchers {
  "Advent of code" must {
    ...
    "Day7" should {
      ...
      "Part2" should {
        "engine compute" should {
          "provide the right results on simplified programs" in {
            //val result1 = Day7.Part2.amplify(
            //  "3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5",
            //  0)
            //result1 shouldBe 139629729
            //val result2 = Day7.Part2.amplify(
            //  "3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,1001,54,-5,54,1105,1,12,1,53,54,53,1008,54,0,55,1001,55,1,55,2,53,55,53,4,53,1001,56,-1,56,1005,56,6,99,0,0,0,0,10",
            //  0)
            //result2 shouldBe 18216
          }
          "provide the right solution with the provided file" in {
            Day7.Part2.amplifyInputFile() shouldBe 8754464
            // TODO implement a wait to retreive the result in the right way, not by using logs...
          }
        }
      }
    }
    "Day8" should {
      "Part1" should {
        "all" in {
          Day8.Part1.runWithInputFile() shouldBe 2193
          Day8.Part2.runWithInputFile() shouldBe """#___#####_#__#_####_####_
                                                   |#___##____#__#_#____#____
                                                   |_#_#_###__####_###__###__
                                                   |__#__#____#__#_#____#____
                                                   |__#__#____#__#_#____#____
                                                   |__#__####_#__#_####_#____""".stripMargin
          // YEHEF
        }
      }
    }
